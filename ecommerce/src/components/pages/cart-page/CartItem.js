    ...
    return (
        <div className='cart-item'>
            ...
            <div className='btns-container'>
                <button className='btns-increase' onClick={() => increase(product)}>
                    <PlusCircleIcon width='20px' />
                </button>
                {
                    quantity === 1 &&
                    <button className='btns-trash' onClick={() => removeProduct(product)}>
                        <TrashIcon width='20px'/>
                    </button>
                }
                {
                    quantity > 1 &&
                    <button className='btns-decrease' onClick={() => decrease(product)}>
